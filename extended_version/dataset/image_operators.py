...
def frost(x, severity=2):
    ...
    filename = [os.path.join("dataset/frost", 'frost1.png'),
                os.path.join("dataset/frost", 'frost2.png'),
                os.path.join("dataset/frost", 'frost3.png'),
                os.path.join("dataset/frost", 'frost4.jpg'),
                os.path.join("dataset/frost", 'frost5.jpg'),
                os.path.join("dataset/frost", 'frost6.jpg')][idx]
