...
def val_on_ViT_Prompt(model, data_loader_val, epoch, save_path, mode, patch_size=None):
    if is_main_process():
        val_model_ViT_Prompt(model, data_loader_val, epoch, save_path, mode, patch_size=None)

def val_model_ViT_Prompt(model, data_loader_val, epoch, save_path, mode='val_pretrain', patch_size=None):
    idx = 0
...
def inference_on_ViT_Prompt(model, data_loader_val, prompt_idx, save_path, mode, patch_size, save_prompt):
    if is_main_process():
        inference_model_ViT_Prompt(model, data_loader_val, prompt_idx, save_path, mode, patch_size, save_prompt)

def inference_model_ViT_Prompt(model, data_loader_val, prompt_idx, save_path, mode='val_pretrain', patch_size=16, save_prompt=False):
    idx = 0
